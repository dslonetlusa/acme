...
/**
 * Class m190311_204740_create_table_country
 */
class m190311_204740_create_table_country extends Migration
{
    /**
     * {@inheritdoc}
     */
...
$this->batchInsert('country', ['id', 'code', 'name', 'phonecode', 'lat', 'lng'], [
    ...
    {
        echo "m190311_204740_create_table_country cannot be reverted.\n";
