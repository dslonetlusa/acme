...
/**
 * Class m190311_201111_create_table_place_lang
 */
class m190311_201111_create_table_place_lang extends Migration
{
    /**
     * {@inheritdoc}
     */
...
$this->addForeignKey('fk_place_lang_place_id_place', 'place_lang', 'place_id', 'place', 'id', 'restrict', 'cascade');
    ...
    {
        echo "m190311_201111_create_table_place_lang cannot be reverted.\n";
